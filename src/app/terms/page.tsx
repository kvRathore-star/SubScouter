            ...
            >
                ...
                <div className="space-y-12 text-muted-foreground/80 leading-relaxed font-medium">
                    <section>
                        ...
                        <p>Sub Scouter provides an intelligence layer for subscription tracking. By initializing the protocol, you grant us permission to analyze your authorized email nodes and export data to your Google Sheets storage.</p>
                    </section>

                    <section>
                        <h2 className="text-xl font-black uppercase italic text-foreground mb-4 tracking-tight">02. Operative Responsibility</h2>
                        <p>You are responsible for maintaining the security of your own Google and Clerk credentials. Sub Scouter is not liable for data loss occurring due to user negligence or unauthorized access at the storage layer.</p>
                    </section>
                    ...
                    <section className="pt-10 border-t border-border/10 text-[10px] font-black uppercase tracking-widest">
                        Protocol Version: 2026.01 / Sub Scouter
                    </section>
                </div>
            </motion.div>
        </div>
