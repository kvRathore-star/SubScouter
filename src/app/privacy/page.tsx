            ...
            >
                ...
                <div className="space-y-12 text-muted-foreground/80 leading-relaxed font-medium">
                    <section>
                        ...
                        <p>Sub Scouter is built on the principle of total data sovereignty. Unlike traditional SaaS tools, we do not operate a centralized database for your financial information. All discovered subscription nodes are stored directly in **your** personal Google Sheet.</p>
                    </section>
